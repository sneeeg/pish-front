        ...
        <div class="architecture-item _row">
          ...
          >
            <path
              ...
              stroke="#F32735"
            />
            <path d="M54 6V68H6" stroke="#F32735" stroke-width="4" />
            <path d="M61 13V75H13" stroke="#F32735" stroke-width="4" />
          </svg>
    ...
    <div class="architecture-component _center">
      ...
      <div class="architecture-component__content">
        ...
        >
          ...
          <HTMLContent v-if="content" :html="content" />
        </div>
      </div>
    </div>
    <div class="architecture-component _side">
      ...
      <div class="architecture-component__content">
        ...
        <div class="architecture-item">
          <p class="architecture-item__name">{{ right.ministryText }}</p>
        </div>
      </div>
    </div>
  </div>
