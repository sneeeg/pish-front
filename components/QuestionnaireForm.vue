  ...
  <transition name="fade" mode="out-in">
    ...
    <form v-else class="questionnaire-form" @submit.prevent="submit">
      ...
      <p class="questionnaire-form__text">
        ...
        ответы на все вопросы. Расскажите о своем решение принять участие в
        программе. Какую цель и какие задачи вы ставите на участие в _. Почему
        участие в _ важно для вас? Какой вклад вы можете внести в этот проект?
        Какие профессиональные цели вы ставите перед собой на период ближайших 5
        лет?
      </p>
